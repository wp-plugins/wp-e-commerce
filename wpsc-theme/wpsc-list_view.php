				...
				<tr class="product_view_<?php echo wpsc_the_product_id(); ?> <?php echo $alt_class;?>">
					...
					<td class="stock">
						...
						<?php if ( wpsc_product_has_stock() ) : ?>
							...
							<img src="<?php echo WPSC_CORE_IMAGES_URL; ?>/yes_stock.gif" alt="Yes" title="Yes" />

						<?php else: ?>

							<img src="<?php echo WPSC_CORE_IMAGES_URL; ?>/no_stock.gif" title='No' alt="No" />
					...
					<td>
						<p id="product_price_<?php echo wpsc_the_product_id(); ?>" class="pricedisplay"><?php echo wpsc_the_product_price(); ?></p>
					</td>
					
					<td>

						<form class='product_form'  enctype="multipart/form-data" action="<?php wpsc_form_action(); ?>" method="post" name="product_<?php echo wpsc_the_product_id(); ?>">
							...
							<?php if ( ( get_option( 'hide_addtocart_button' ) == 0 ) && ( get_option( 'addtocart_or_buynow' ) != '1' ) ) : ?>
								...
								<?php if ( wpsc_product_has_stock() ) : ?>
									...
									<div class="wpsc_buy_button_container">
										...
										<?php if ( wpsc_is_product_external() ) : ?>

											<input class="wpsc_buy_button" type="button" value="<?php _e( 'Buy Now', 'wpsc' ); ?>" onclick="gotoexternallink('<?php echo wpsc_product_external_link(); ?>')">
