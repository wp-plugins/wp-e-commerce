				...
				<?php if(wpsc_product_on_special()) : ?><span class="sale"><?php _e('Sale', 'wpsc'); ?></span><?php endif; ?>		
					<div class="productcol">
						...
						<div class="additional_description_container">
								...
								<img class="additional_description_button"  src="<?php echo WPSC_CORE_THEME_URL; ?>images/icon_window_expand.gif" alt="Additional Description" /><a href="<?php echo wpsc_the_product_permalink(); ?>" class="additional_description_link"><?php _e('More Details', 'wpsc'); ?>
							</a>
