		...
		<div class="wrap">
			...
			<p>
				...
				<label for='wpsc_tax_shipping'>
					...
					<?php _e( 'Apply tax to shipping and handling', 'wpsc' ); ?>
				</label>
			...
			<p>
				...
				<label for='wpsc_tax_inprice2'>
					...
					<?php _e( 'Product prices are tax inclusive - during checkout the total price does not increase but tax is shown as a line item', 'wpsc' ); ?>
				</label>
			...
			<p>
				...
				<label for='wpsc_tax_logic_1'>
					...
					<?php _e( 'Apply tax when Billing and Shipping Country is the same as Shops base location', 'wpsc' ); ?>
				</label>
			...
			<p>
				...
				<label for='wpsc_tax_logic_2'>
					...
					<?php _e( 'Apply tax when Shipping Country is the same as Shops base location', 'wpsc' ); ?>
				</label>
			...
			<p>
				...
				<label for='wpsc_tax_logic_3'>
					...
					<?php _e( 'Apply tax when Billing Country is the same as Shops base location', 'wpsc' ); ?>
				</label>

			</p>

			<h4><?php _e( 'Tax Rates', 'wpsc' ); ?></h4>
			<p>
