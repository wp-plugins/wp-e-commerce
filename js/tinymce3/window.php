		...
		<form name="WPSC" action="#">
			<div class="tabs">
				<ul>
					...
					<li id="product_slider"><span><a href="javascript:mcTabs.displayTab('product_slider','product_slider_panel');" onmousedown="return false;"><?php _e("Product Slider", 'wpsc_category'); ?></a></span></li>
...
if(is_array($categorylist)) {
	foreach($categorylist as $category) {
		echo "<option value=".$category['id']." >".$category['name']."</option>"."\n";
						...
						<tr>
							<td><?php _e("Number of visible items", 'wpsc_category'); ?>:</td>
							<td>
				...
				<div id="add_product_panel" class="panel">
					...
					<table border="0" cellpadding="4" cellspacing="0">
						...
						<tr>
							<td><label for="add_product_category"><?php _e("Category", 'wpsc_category'); ?></label></td>
							<td>
