...
function wpsc_update_product_price() {
	...
	echo "you_save_amount=\"" . wpsc_currency_display( wpsc_you_save( array( 'product_id' => (int)$_POST['product_id'], 'type' => 'amount' ) ), array( 'display_as_html' => false ) ) . "\";\n";
	echo "you_save_percentage=\"" . number_format( wpsc_you_save( array( 'product_id' => (int)$_POST['product_id'] ) ) ) . "\";\n";
